...
log using "${project_directory}\programs\_LOGS\09_create_v02_phdcn_merged_mi.log", replace

/*
DO-FILE NAME: 09_create_v02_phdcn_merged_mi.do
AUTHOR: Sagi Ramaj
...
mi register regular ncondadvg_1 nBL5_1
...
mi impute chain ///
	(mlogit, include(ncondadvg_1 nBL5_1) ///
			 omit(i.nPCEnglish_2 i.nPCPublicAssist_2 i.nPCMarried_2 i.nPCEmployed_2 nlnSalary_2 nBL5_2 ///
				  ...
				  nSUBAge_3 nPPVTScore_3)) ///
		nSUBEthnicity_1 ///
	(ologit, include(ncondadvg_1 nBL5_1)) ///
		nPCEdu_1	///
	(logit, include(ncondadvg_1 nBL5_1)) ///
	...
	(pmm, include(ncondadvg_1 nBL5_1) knn(10)) ///
		nPCAge_1 nFamSize_1 ///
